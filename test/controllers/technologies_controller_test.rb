...
class TechnologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post technologies_url, params: { technology: { name: @technology.name, rank: @technology.rank } }
    end
  ...
  test "should update technology" do
    patch technology_url(@technology), params: { technology: { name: @technology.name, rank: @technology.rank } }
